defmodule Day1.TrebuchetTest do
  ...
  describe "calc_calibration_value/1" do
    test "initial test" do
      ...
      assert expect_result === Trebuchet.calculate_total(input)
    end

    @tag :skip
    test "puzzle test" do
      """
      This test broker because of part 2 but remove the code about part two this test back to work
      """
...
26fmrrhhpthree6b"
      ...
      assert expect_result ===
               String.split(input, "\n") |> Trebuchet.calculate_total()
    end

    test "initial test of Part Two" do
      expect_result = 281
  ...
  test "Puzzle test of Part Two" do
    expect_result = 53515
